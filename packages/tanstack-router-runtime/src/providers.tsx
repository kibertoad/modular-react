 ...
 * the host owns routing (TanStack Router file-based mode with
 * `@tanstack/router-plugin`, or TanStack Start — both expect the host to
 * call `createRouter({ routeTree })` against a generated route tree).
 *
