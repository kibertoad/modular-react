import type { NavigationItem, NavigationItemBase } from "@modular-frontend/core";
import type { ModuleDescriptor, SlotMap, SlotMapOf } from "./types.js";

/**
 * Identity function that provides type inference for Angular Router module descriptors.
