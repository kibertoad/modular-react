...
/**
 * Typed route data every route contributes on its `meta`. Shell zones read
 * this via `useRouteData<AppRouteData>()` — when the user navigates between
 * sibling integrations, the data flips automatically.
 */
