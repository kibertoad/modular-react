...
interface ContentfulSourceInput {
   ...
   * projection; this module reads via `useSyncExternalStore` and writes
   * via `selectedItem.set(...)`. The module does not know the
   * composition's state shape — only that a `WritableStore<string | null>`
   * is wired in.
   */
