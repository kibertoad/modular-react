...
/**
 * The parent journey reaches this step only after the child age-verify
 * journey has completed and the parent's resume handler has folded the
 * verification token into state. The token shows up here typed thanks to
 * the journey's TOutput phantom on the child handle.
 */
