...
/**
 * The parent journey's first step. The user reviews the order and either
 * proceeds (which causes the parent to `invoke` the age-verification child
 * journey) or cancels (which aborts the parent). The module knows nothing
 * about journeys — it just emits typed exits.
 */
