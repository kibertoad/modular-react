...
import type { AppSlots } from "@example-tsr-integration-setup/app-shared";
import type { ChooserExits } from "./exits.js";
...
export function ChooseIntegration({
  exit,
}: ModuleEntryProps<ChooseIntegrationInput, ChooserExits>) {
