...
import type chooserModule from "@example-tsr-integration-setup/chooser-module";
import type genericModule from "@example-tsr-integration-setup/generic-module";
