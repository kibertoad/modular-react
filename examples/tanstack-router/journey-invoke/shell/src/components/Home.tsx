...
import { checkoutHandle } from "@example-tsr-invoke/checkout-journey";
...
export function Home({ runtime }: Props) {
  ...
  if (instanceId === null) {
    return (
      <Layout>
        <h1 style={{ marginBottom: "1rem" }}>Journey invoke / resume — TanStack Router</h1>
  ...
  return (
    <Layout>
      <header style={{ display: "flex", alignItems: "center", marginBottom: "1rem" }}>
        <h1 style={{ flex: 1 }}>Journey invoke / resume — TanStack Router</h1>
