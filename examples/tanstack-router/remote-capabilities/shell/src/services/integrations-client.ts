...
function validateManifests(raw: unknown): readonly AppRemoteManifest[] {
  ...
  return raw.map((entry, i) => {
    ...
    // Trust the slot contents past this point — the structural TS type on
    // the return value is what consumers rely on. Tighten per-slot shapes
    // here if you want stricter runtime guarantees.
