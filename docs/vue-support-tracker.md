...
Status: **Phase 2 in progress** (Phase 0: PR-01, PR-02, PR-03 landed; Phase 1: PR-10, PR-11, PR-12 landed; Phase 2: PR-20, PR-21, PR-22, PR-23 landed). Last updated: 2026-07-16.
...
Acceptance: met. 49 new tests across `zones.test.ts` (6), `active-zones.test.ts` (7, incl. a ref-reactivity case), `route-data.test.ts` (12), and `slots.test.ts` (24) port the React suites case-for-case; deepest-wins merge, undefined-skip, and module-over-route precedence all match. Package total 107. Full workspace typecheck and `vite build` (JS + dts) pass; externals (`vue`, `vue-router`, `@modular-frontend/core`, `@modular-vue/vue`, `@modular-vue/core`) stay unbundled.
