...
| `@modular-vue/journeys`     | `@modular-react/journeys`       | `@modular-frontend/journeys-engine`     | Full **except `createJourneyMountAdapter`** (gap PR-44)                           |
...
- **PR-44 — `@modular-vue/journeys` `createJourneyMountAdapter` (journey-in-zone).**
  ...
  was never ported in PR-30/PR-31. Until PR-44 lands, journey-in-composition-zone
...
| PR-44 | @modular-vue/journeys createJourneyMountAdapter (journey-in-zone) | S    | PR-31, PR-34        | todo (parity-audit follow-up) |
