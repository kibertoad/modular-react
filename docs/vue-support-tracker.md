...
**PR-40 (L): `examples/vue-router` example apps.** Done.
Mirrors the `examples/react-router` / `examples/tanstack-router` layout (a family of focused example workspaces, matching how tanstack-router mirrored react-router) rather than one combined app — three example workspaces under `examples/vue-router/`, each self-contained, SFC-authored (decision D4), and wired with the patterns the docs will teach:
...
| PR-40 | examples/vue-router                         | L    | PR-23, PR-32, PR-34 | done       |
