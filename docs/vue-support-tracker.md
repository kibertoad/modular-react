...
| `@modular-vue/journeys`     | `@modular-react/journeys`       | `@modular-frontend/journeys-engine`     | Full (incl. `createJourneyMountAdapter`, PR-35)                                   |
...
- **PR-35 — `@modular-vue/journeys` `createJourneyMountAdapter` (journey-in-zone). Done.**
...
| `journeys`          | 88 (11)           | 72 (8)                          | +`mount-adapter` (PR-35); engine (346) shared via `@modular-frontend/journeys-engine`          |
...
| PR-35 | @modular-vue/journeys createJourneyMountAdapter (journey-in-zone) | S    | PR-31, PR-34        | done (parity-audit follow-up) |
