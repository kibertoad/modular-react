...
- [`examples/tanstack-router/customer-onboarding-journey/`](../examples/tanstack-router/customer-onboarding-journey) — three-module branching flow with reload-safe persistence.
